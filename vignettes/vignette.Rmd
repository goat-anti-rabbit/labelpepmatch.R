...
This closer look gives away that we are actually looking at only 3 different peptides, with charges ranging between 2 and 4. Most probabily, since the patterns of expression for the 1644 Da and the 2909 Da peptides align so well, we are looking at a longer isoform or precursor of the Scg-PK-5 peptide. The 790 Da peptide remains unkown, but it may well be a fragment that is also co-encoded in the larger precursor. 
...
For more information, the reader is referred to the limma manual. 
